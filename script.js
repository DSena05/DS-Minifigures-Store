...
// Banner de teste com URLs de imagens online
const banners = [
...
function renderProducts(list) {
  ...
  list.forEach(p => {
    ...
    card.innerHTML = `
      ...
      <h4>${p.title}</h4>
      <p>${p.desc}</p>
      <small>Categoria: ${p.category} • ${p.stock > 0 ? `Restam ${p.stock}` : "Sem estoque"}</small>
...
// Produtos
const products = [
  { id: "p2", title: "Thanos Miniatura", price: 10.0, oldPrice: 15.0, promo: true, desc: "Lança de 2 Pontas", category: "Marvel", stock: 1, img: "thanos.jpg" },
  { id: "p3", title: "Mulher Aranha", price: 19.99, desc: "Capacete e Base", category: "Marvel", stock: 1, img: "https://i.ebayimg.com/images/g/Ae8AAOSwXpdmKBBK/s-l1200.jpg" },
  { id: "p4", title: "Mulher Invisivel", price: 19.99, desc: "Effect e Bebê Franklin", category: "Marvel", stock: 1, img: "https://brixtoy.com/wp-content/uploads/2025/07/Marvel-Invisible-Woman-First-Steps-GH0379-Minifigures.png" },
  { id: "p5", title: "Capitão America", price: 19.99, desc: "Escudo e Capacete", category: "Marvel", stock: 1, img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPJo_atLL09rRfb5L6iZHGR2DF3ZVpaHJFGw&s" },
  { id: "p6", title: "Ichigo Kurosaki", price: 25.0, desc: "Figura especial sob encomenda", category: "Animes", stock: 0, preOrder: true, arrivalTime: "3 semanas-1 Mês", img: "https://brixtoy.com/wp-content/uploads/2023/11/Anime-Bleach-Ichigo-Kurosaki-WM2567-Minifigures-300x300.jpg" },
  { id: "p7", title: "Tocha Humana", price: 25.00, desc: "Effect e Base de Fogo", category: "Marvel", stock: 1, img: "https://brixtoy.com/wp-content/uploads/2025/07/Marvel-Human-Torch-First-Steps-GH0384-Minifigures.png" },
  { id: "p8", title: "Doutor Destino", price: 25.0, desc: "Figura especial sob encomenda", category: "Marvel", stock: 0, preOrder: true, arrivalTime: "3 semanas-1 Mês", img: "https://brixtoy.com/wp-content/uploads/2025/08/Marvel-Dr-Doom-SDCC-TV1104-Minifigures.jpg" },
  { id: "p9", title: "Darth Vader", price: 25.0, desc: "Figura especial sob encomenda", category: "Star Wars", stock: 0, preOrder: true, arrivalTime: "3 semanas-1 Mês", img: "https://shoplineimg.com/5ae29b268d1db9dde9005d08/673718ba8d69d9000abca8e8/800x.jpg?" },
];
...
const banners = [
  { img: "https://i.pinimg.com/736x/7f/fc/54/7ffc54ce7b4745feeb359054045c23e5.jpg", text: "Promoção Marvel e DC!" },
  { img: "https://images.hdqwalls.com/wallpapers/bthumb/the-mandalorian-precious-moments-with-the-baby-yoda-ii.jpg", text: "Lançamentos Star Wars!" },
  { img: "https://sdmntprcentralus.oaiusercontent.com/files/00000000-5b38-61f5-9710-02b34dfbd10f/raw?se=2025-09-29T21%3A28%3A35Z&sp=r&sv=2024-08-04&sr=b&scid=9cffb1cb-83f5-5a10-ae8a-5d18c54e7827&skoid=c953efd6-2ae8-41b4-a6d6-34b1475ac07c&sktid=a48cca56-e6da-484e-a814-9c849652bcb3&skt=2025-09-29T18%3A48%3A32Z&ske=2025-09-30T18%3A48%3A32Z&sks=b&skv=2024-08-04&sig=UpdeYdTr6uHsnvSWs%2BlzNIRRkxFV3hVY2AL6%2BcFGKss%3D", text: "Kits Especiais DS Minifigs!" }
];
...
function saveCart(){localStorage.setItem("cart",JSON.stringify(cart));}
function loadCart(){return JSON.parse(localStorage.getItem("cart")||"[]");}
>>>>>>> 21da7061215240eba0f2ea14bfc33dfc920a9e9d
