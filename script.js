...
const products = [
  ...
  { id: "p15", title: "Quarteto Fantástico", price: 65.00, desc: "Equipe Quarteto Fantástico Completo com Acesórrios e 1 surfista(Escolha)", category: ["Kits", "Marvel"], stock: 0, preOrder:true, arrivalTime: "3 semanas - 6 semanas", img: "quarteto.png" },
...
function setupEvents(){
  ...
  function applyFilters(){
    ...
    if(cat !== "all") arr = arr.filter(p => p.category.includes(cat));
